...
# Код дополнен для поддержки всех формул (4.1 - 4.3), включая детализированные методы 4.1.1 - 4.1.4.
...
class Category4Calculator:
    ...
    def calculate_catalyst_regeneration(self, coke_burnoff: float, coke_carbon_content: float = 0.94) -> float:
        ...
        :param coke_burnoff: Масса выгоревшего кокса на катализаторе, т. 
                             (Это значение может быть введено напрямую или рассчитано методами 
                             calculate_coke_burnoff_continuous/periodic).
