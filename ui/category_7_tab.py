...
class Category7Tab(TabDataMixin, QWidget):
    """
    ...
    def _init_ui(self):
        ...
        self.method_combobox.setToolTip(
            "Выберите метод расчета в зависимости от имеющихся у вас данных."
        )
    ...
    def _create_raw_materials_widget(self):
        ...
        self.raw_dust_mass_input.setToolTip(
            "Масса известковой пыли, уловленной и не возвращенной в печь."
        )
    ...
    def _create_lime_widget(self):
        ...
        self.lime_production_input.setToolTip(
            "Общая масса произведенной извести за отчетный период."
        )
        self.lime_cao_fraction_input = self._create_line_edit(
            "", (0.0, 1.0, 4), "Напр., 0.95"
        )
        self.lime_cao_fraction_input.setToolTip(
            "Массовая доля оксида кальция (CaO) в извести."
        )
        self.lime_mgo_fraction_input = self._create_line_edit(
            "", (0.0, 1.0, 4), "Напр., 0.01"
        )
        self.lime_mgo_fraction_input.setToolTip(
            "Массовая доля оксида магния (MgO) в извести."
        )
        lime_form.addRow("Масса извести (т):", self.lime_production_input)
        lime_form.addRow("Доля CaO в извести:", self.lime_cao_fraction_input)
        lime_form.addRow("Доля MgO в извести:", self.lime_mgo_fraction_input)
        ...
        self.lime_dust_mass_input.setToolTip(
            "Масса известковой пыли, уловленной и не возвращенной в печь."
        )
    ...
    def _perform_calculation(self):
        try:
            ...
            logging.critical(
                f"Category 7 Calculation - Unexpected error: {e}", exc_info=True
            )
