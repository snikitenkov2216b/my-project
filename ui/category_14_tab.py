...
class Category14Tab(QWidget):
    ...
    def _add_raw_material_row(self):
        items = self.data_service.get_metallurgy_raw_materials()
    ...
    def _add_product_row(self):
        items = self.data_service.get_metallurgy_products()
        self._create_dynamic_row("Выход, т", self.products_layout, self.product_rows, items)

    def _add_by_product_row(self):
        items = self.data_service.get_metallurgy_products() + self.data_service.get_fuels_table_1_1()
